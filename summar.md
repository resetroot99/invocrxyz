...
## Monorepo Scaffold & Initial File Structure

Below is the complete directory tree and minimal starter files for your InvOCR monorepo.
...
### 6. `apps/web/tsconfig.json` & `apps/api/tsconfig.json`

Use the default Next.js and Vercel TS configs—extending `../../tsconfig.base.json` when you add one.

---

This scaffold gives you the physical monorepo setup; from here, use the build guide’s modules to populate each package and app.
